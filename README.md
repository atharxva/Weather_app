...
- **JavaScript:** For fetching weather data and updating the interface dynamically.

## How to Use
1. Clone the repository to your local machine.
2. Open `index.html` in your preferred web browser.
3. Enter the name of the city in the input field.
4. Press the "Get Temperature" button.
5. Voila! The current temperature of the entered city will be displayed.
